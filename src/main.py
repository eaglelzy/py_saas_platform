...
from src.core.exception_handlers import base_api_exception_handler, general_exception_handler, http_exception_handler, starlette_http_exception_handler, validation_exception_handler
from src.core.exceptions import BaseAPIException
from starlette.exceptions import HTTPException as StarletteHTTPException  # 添加这行
...
app.include_router(tenants_api.router, prefix=settings.API_V1_STR, tags=["Tenants"])
